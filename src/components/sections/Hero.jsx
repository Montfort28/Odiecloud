        ...
        <div className="bg-linear-to-br from-blue-900 via-blue-800 to-cyan-400 rounded-4xl overflow-hidden border border-white/15 shadow-2xl relative group hover:shadow-glow-lg transition-all duration-300">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1.15fr_0.85fr] gap-7 items-center p-8 md:p-16 relative z-10">
            ...
            <div style={{animation: 'fadeIn 0.5s ease-out'}}>
              <div className="inline-flex items-center gap-2.5 px-3.5 py-2.5 rounded-full bg-white/12 border border-white/22 text-white text-xs uppercase tracking-wider mb-5 hover:bg-white/18 transition-colors duration-300 backdrop-blur-sm" style={{fontFamily: '"Inter", sans-serif', fontWeight: 600}}>
              ...
              <h1 className="text-white m-0 mb-4 text-4xl md:text-5xl lg:text-6xl leading-[0.98] font-semibold max-w-5xl hover:drop-shadow-lg transition-all duration-300" style={{fontFamily: '"Inter", sans-serif', fontWeight: 700, letterSpacing: '-0.02em'}}>
                Join the ecosystem built to structure growth, trade, capital, technology, and market access.
              </h1>

              <p className="text-white/92 m-0 mb-6 text-lg md:text-xl leading-relaxed max-w-2xl" style={{fontFamily: '"Inter", sans-serif', fontWeight: 400}}>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3.5">
                {[
                  ...
                  >
                    <div className="text-3xl leading-none mb-1.5 group-hover:drop-shadow-lg transition-all duration-300" style={{fontFamily: '"Inter", sans-serif', fontWeight: 700}}>
                      {stat.value}
                    </div>
                    <div className="text-xs leading-snug group-hover:text-white transition-colors duration-300" style={{fontFamily: '"Inter", sans-serif', fontWeight: 500}}>
                      {stat.label}
                    </div>
                  </div>
                ))}
