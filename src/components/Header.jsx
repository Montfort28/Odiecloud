        ...
        <div className="hidden lg:block py-4">
          ...
          <div className="flex items-center justify-between gap-6 mb-3">
            ...
            <div className="flex items-center gap-3.5 shrink-0">
              ...
              />
              <div>
                <div className="font-bold text-xl leading-tight text-slate-800" style={{fontFamily: '"Inter", sans-serif', fontWeight: 700}}>ODIECLOUD²π</div>
                <div className="text-xs text-slate-600 font-medium mt-0.5 max-w-xs" style={{fontFamily: '"Inter", sans-serif', fontWeight: 500}}>Governance-Engineered<br />Ecosystem Access</div>
              </div>
            </div>
        ...
        <div className="lg:hidden">
          <div className="flex items-center justify-between gap-4 min-h-17.5 py-3">
            <div className="flex items-center gap-3 shrink-0">
              ...
              />
              <div>
                <div className="font-bold text-lg leading-tight text-slate-800" style={{fontFamily: '"Inter", sans-serif', fontWeight: 700}}>ODIECLOUD²π</div>
                <div className="text-xs text-slate-600 font-medium" style={{fontFamily: '"Inter", sans-serif', fontWeight: 500}}>Ecosystem Access</div>
              </div>
            </div>
            ...
            <div className="pb-4 border-t border-sky-100/50">
              <nav className="flex flex-col gap-2 pt-4">
                ...
                <div className="flex flex-col gap-2.5 mt-4 pt-4 border-t border-sky-100/50">
                  <a href="#profit-centres" className="btn btn-primary text-[15px] w-full" style={{fontFamily: '"Inter", sans-serif', fontWeight: 600}}>
                    Explore Solutions
                  </a>
                  <a href="#communities" className="btn btn-primary text-[15px] w-full" style={{fontFamily: '"Inter", sans-serif', fontWeight: 600}}>
                    Membership Types
                  </a>
                  <a href="#access" className="btn btn-primary text-[15px] w-full" style={{fontFamily: '"Inter", sans-serif', fontWeight: 600}}>
                    Request Membership Access
                  </a>
                </div>
              </nav>
